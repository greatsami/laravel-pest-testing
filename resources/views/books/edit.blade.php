<x-layouts.app>
    ...
    <form action="/books/{{ $book->id }}" method="post" class="mt-4 space-y-4">
        ...
        <div class="space-y-1">
            ...
            <input type="text" name="title" id="title" value="{{ old('title', $book->title) }}" class="rounded block w-full">
            @error('title')
        ...
        <div class="space-y-1">
            ...
            <input type="text" name="author" id="author" value="{{ old('author', $book->author) }}" class="rounded block w-full">
            @error('author')
            <div class="text-red-500 text-sm">{{ $message }}</div>
            @enderror
        </div>
